...
export default function Home() {
  return (
    <div className="wc-hero relative flex flex-1 items-center justify-center overflow-hidden px-4 py-12">
      {/* estadio: ilustración SVG de base */}
      <div
        ...
        aria-hidden
      />
      {/* estadio: si existe public/stadium.jpg, una foto real lo cubre */}
      <div
